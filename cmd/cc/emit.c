...
extern void emitter_emit_file(emitter_t *e, file_t *file) {
    emit_printf(e, "#pragma GCC diagnostic ignored \"-Wincompatible-library-redeclaration\"\n");
    emit_printf(e, "//kc:package ");
    emit_expr(e, file->name);
    emit_printf(e, "\n");
    for (expr_t **imports = file->imports; imports && *imports; imports++) {
        emit_printf(e, "//kc:import ");
        emit_expr(e, *imports);
        emit_printf(e, "\n");
    }
    emit_printf(e, "\n");
